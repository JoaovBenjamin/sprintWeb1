...
import { SectionCorpoHome, TituloD, BtnAtendimento, Section, Paragrafo, ImgHome, Sectionparagrafo, LinkButton, ContainerParagrafo } from "../Estilos/Estilos";
       ...
       <>
            <Section>
                ...
                <SectionCorpoHome>
                    ...
                    <BtnAtendimento><LinkButton href="/inicio">Iniciar Atendimento</LinkButton></BtnAtendimento>
                </SectionCorpoHome>
            </Section>
       </>
    )            
